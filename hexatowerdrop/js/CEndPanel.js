function CEndPanel(iScore) {
    ...
    this._init = function() {
        ...
        _oMsgTextGameOver = new CTLText(_oPanelContainer,
            CANVAS_WIDTH / 2 - 250, CANVAS_HEIGHT_HALF - 200, 500, 84,
        ...
        _oMsgTextFinalScore = new CTLText(_oPanelContainer,
            CANVAS_WIDTH / 2 - 250, CANVAS_HEIGHT_HALF - 70, 500, 36,
        ...
        _oMsgTextFinalLines = new CTLText(_oPanelContainer,
