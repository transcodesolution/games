function CWinText(szType, iX, iY, bVisible) {
    ...
    this.great = function() {
        ...
        var oParent = this;
        createjs.Tween.get(_oTextContainer).to({
            scaleX: 1,
            scaleY: 1
        }, 100, createjs.Ease.linear).wait(2000).call(function() {
            oParent.unload();
        });
    };
    ...
    this.splat = function() {
        ...
        createjs.Tween.get(_oTextContainer).to({
            ...
            alpha: 0
        }, 2500, createjs.Ease.linear);
        createjs.Tween.get(_oTextContainer).wait(2000).to({
            alpha: 0
