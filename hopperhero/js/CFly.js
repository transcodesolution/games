function CFly(iX, iY, iCell) {
    ...
    this._init = function(iX, iY, iCell) {
        ...
        var oParent = this;
        createjs.Tween.get(_oFly).wait(TIME_FLY_TO_DISAPPEAR).call(function() {
            oParent.unload();
            s_oGame.freeCell(iCell);
        }); //.to({alpha : 0}, 4000, createjs.Ease.linear).call(function(){oParent.unload();});
    };
