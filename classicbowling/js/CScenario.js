function CScenario() {
    ...
    this._init = function() {
        ...
        var oPosLeftFloor = {
            x: FLOOR_PINS_POSITION.x + fOffsetXLeft,
        ...
        var oPosLeftRight = {
            x: FLOOR_PINS_POSITION.x + fOffsetXRight,
            y: FLOOR_PINS_POSITION.y,
            z: FLOOR_PINS_POSITION.z + FLOOR_PINS_SIZE.height - 9
        };
    ...
    this.createSensorPinFloor = function() {
        ...
        _oSensorPinFloor = new CANNON.Body({
            mass: 0,
        ...
        if (SHOW_3D_RENDER) {
            var sensorMaterial = new THREE.MeshPhongMaterial({
                color: 0x550055,
                specular: 0x111111,
                shininess: 50
            });
    ...
    this.createDepthTrack = function() {
        ...
        _oBodyDepthTrack = new CANNON.Body({
            mass: 0,
            material: _oWallMaterial
        });
        ...
        if (SHOW_3D_RENDER) {
            var depthMaterial = new THREE.MeshPhongMaterial({
                color: 0x888800,
                specular: 0x111111,
                shininess: 50
            });
    ...
    this.createFloorPins = function() {
        ...
        _oPinFloorBody = new CANNON.Body({
            mass: 0,
            material: _oGroundMaterial,
            userData: {
                type: PINS_FLOOR
    ...
    this.createWallFloorPins = function() {
        ...
        _oPinWallForwardBody = new CANNON.Body({
            mass: 0,
            material: _oGroundMaterial,
            userData: {
                type: PINS_FLOOR
    ...
    this.createPinsBinder = function() {
        ...
        _oPinsBinderBody = new CANNON.Body({
            mass: 0,
            material: _oWallMaterial,
            userData: {
                type: PINS_FLOOR
        ...
        if (SHOW_3D_RENDER) {
            var binderMaterial = new THREE.MeshPhongMaterial({
                color: 0x555555,
                specular: 0x111111,
                shininess: 50
            });
    ...
    this.createPin = function(oPos, iID, bEnableTrackBall) {
        ...
        var oPinBody = new CANNON.Body({
            mass: PIN_PROPERTY.mass,
            material: _oPinMaterial,
    ...
    this.createWallPins = function() {
        ...
        _oBodyWallPins = new CANNON.Body({
            mass: 0,
            material: _oWallMaterial,
            userData: {
                type: WALL
    ...
    this.createSideWallTrack = function() {
        ...
        _oSideWallBody = new CANNON.Body({
            mass: 0,
            material: _oWallMaterial,
            userData: {
                type: WALL_TRACK
        ...
        if (SHOW_3D_RENDER && SHOW_PROXY_COLLISION) {
            var sideWallMaterial = new THREE.MeshPhongMaterial({
                color: 0xaaaaaa,
                specular: 0xffffff,
                shininess: 15
            });
