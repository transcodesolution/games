function CPin(iXPos, iYPos, oSprite, oPhysics, oParentContainer) {
    ...
    this.createPin = function() {
        ...
        var oData = {
            ...
            frames: {
                width: oSprite.width / 10,
                height: oSprite.height / 8,
                regX: (oSprite.width / 10) / 2,
                regY: (oSprite.height / 8) / 2
            }
        };
    ...
    this.setDown = function(bVal) {
        ...
        if (bVal) {
            createjs.Tween.get(this).wait(750).call(function() {
                s_oScenario.setElementVelocity(_oPhysics, {
                    x: 0,
                    y: 0,
                    z: 0
                });
    ...
    this.animReposition = function(iY, fAlpha) {
        createjs.Tween.get(_oPin).to({
            y: iY
        }, 500);
        createjs.Tween.get(_oReflection).wait(250).to({
            alpha: fAlpha
        }, 200);
    };
    ...
    this.animTake = function(iY) {
        ...
        createjs.Tween.get(_oReflection).to({
            alpha: 0
        }, 200);
    };
