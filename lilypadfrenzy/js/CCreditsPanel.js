function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        _oMsgTextOutline = new createjs.Text("BROUGHT TO YOU BY", "24px " + FONT_GAME, "#008733");
        ...
        _oMsgText = new createjs.Text("BROUGHT TO YOU BY", "24px " + FONT_GAME, "#fff");
        ...
        _oLinkOutline = new createjs.Text("CBC Kids", "18px " + FONT_GAME, "#008733");
        ...
        _oLink = new createjs.Text("CBC Kids", "18px " + FONT_GAME, "#fff");
    ...
    this._onLogoButRelease = function() {
        window.open("https://cbckids.ca/games", "_blank");
    };
