function CNextLevel() {
    ...
    this._init = function() {
        ...
        _oMsgTextBack = new createjs.Text("LEVEL 2", "48px " + FONT_GAME, "#008733");
        _oMsgTextBack.x = CANVAS_WIDTH / 2;
        _oMsgTextBack.y = (CANVAS_HEIGHT / 2) - 30;
        _oMsgTextBack.outline = 2;
        ...
        _oScoreTextBack = new createjs.Text("SCORE 99999", "34px " + FONT_GAME, "#008733");
        _oScoreTextBack.x = CANVAS_WIDTH / 2;
        _oScoreTextBack.y = (CANVAS_HEIGHT / 2) + 30;
        _oScoreTextBack.outline = 2;
