function CCitySettings() {
    ...
    this.initCityName = function() {
        _aCityName.push("Toronto");
        _aCityName.push("Montreal");
        _aCityName.push("Halifax");
        _aCityName.push("Vancouver");
        _aCityName.push("Calgary");
        _aCityName.push("Winnipeg");
        _aCityName.push("Saskatoon");
        _aCityName.push("Fredericton");
        _aCityName.push("Edmonton");
        _aCityName.push("Chralottetown");
    };
