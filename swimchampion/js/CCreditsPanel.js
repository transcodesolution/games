function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        _oMsgText = new CFormatText(CANVAS_WIDTH / 2, 250, "Brought to you by", "#ffffff", s_oStage, "#410701", 40);

        _oLink = new CFormatText(CANVAS_WIDTH / 2, 450, "CBC Kids", "#ffffff", s_oStage, "#410701", 40);
    ...
    this._onLogoButRelease = function() {
        window.open("https://www.cbckids.ca/games");
    };
